...
| **MtrMto** | 3 | Minimal functional Mtr complex: MtrA–MtrB–MtrC for iron reduction (*Shewanella*; White et al. 2013, *PNAS*, doi:10.1073/pnas.1222358110); or MtoA–MtrB–ImoA for iron oxidation (*Sideroxydans*; Liu et al. 2012, *Front. Microbiol.*, doi:10.3389/fmicb.2012.00037, characterized MtoA; ImoA renamed/characterized by a 2022 mBio paper, doi:10.1128/mbio.02150-22 — see below). Both share MtrB as the outer membrane scaffold. The full rule gene list has 5 entries (covering both systems); canonical_size=3 reflects the core trimer regardless of direction. **Not CymA**: Liu et al. 2012 originally called the oxidation-side gene "CymA-like" from loose NapC/NirT-superfamily sequence similarity; the 2022 paper showed it is only 33% identical to real Shewanella CymA (64%/54% identical to NirT/NapC instead) and renamed it ImoA (Slit_2495). Real CymA (Myers & Myers 1997, *J. Bacteriol.*, doi:10.1128/jb.179.4.1143-1152.1997) is a genuine, separate, well-characterized Shewanella gene — required for Fe(III)/nitrate/fumarate reduction, feeding electrons into MtrA — but it isn't part of this operon rule's oxidation side; see `docs/hmm_library_curation.md` for the full correction writeup and both new models. |
